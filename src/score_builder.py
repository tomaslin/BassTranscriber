import fractions
from music21 import stream, note, meter, instrument, metadata, tie, articulations
...
def build_and_export_score(
    ...
    """Builds music21 score stream, applies engraving layout rules, and exports MusicXML."""
    ...
    for i, note_evt in enumerate(note_layer):
        ...
        for k, chunk_dur in enumerate(note_chunks):
            ...
            if note_evt.tag == "staccato" and k == 0:
    ...
    # 3. Fill remaining space in the final measure if incomplete
    ...
    sanitize_and_inject_tablature(output_xml_path, artist_name, song_title, '4_string_standard', level=target_level)
